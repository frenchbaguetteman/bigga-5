...
void left43() {
  ...
  chassis.pid_wait();
  const uint32_t tiny_turn_elapsed_ms = pros::millis() - tiny_turn_start_ms;
  if (tiny_turn_elapsed_ms < 350) pros::delay(350 - tiny_turn_elapsed_ms);
...
void left7wing() {
  ...
  chassis.pid_wait();
  const uint32_t tiny_turn_elapsed_ms = pros::millis() - tiny_turn_start_ms;
  if (tiny_turn_elapsed_ms < 900) pros::delay(900 - tiny_turn_elapsed_ms);
